...
fun MyApp(
    ...
    val screenTitles = mapOf(
        ...
        "patient_profile_screen/{phone}" to "Профиль пациента",
        "notification_screen" to "Уведомления",
        "entry_screen" to "Вход",
        "edit_patient_screen" to "Редактирование профиля",
        "edit_patient_screen/{phone}" to "Редактирование профиля",
        "edit_doctor_screen" to "Редактирование профиля",
